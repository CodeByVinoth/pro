...
import { Mail, Phone, Instagram, FileText, MapPin, Send, User, MessageSquare } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            {contactItems.map((item, index) => (
              ...
              >
                <div className={`flex items-center justify-center w-12 h-12 rounded-lg ${item.color} transition-all mr-4`}>
                  <item.icon className="w-5 h-5 text-white" />
                </div>
                <div>
                  <p className="text-sm text-gray-400 mb-1">Contact via</p>
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-lg bg-slate-700 border border-slate-600 focus:border-blue-400 focus:ring-1 focus:ring-blue-400 focus:outline-none text-white transition-all"
        ...
        >
          <div className="inline-flex items-center px-6 py-3 rounded-full bg-slate-800 bg-opacity-70 backdrop-blur-sm border border-slate-700 shadow-lg hover:border-blue-400 transition-colors">
